...
import { EmployeeMasterPanel, LeaveAndOrgPanel, HrActionHeader } from "@/components/admin/hr";

export const metadata: Metadata = { title: "HR & Workforce | Zoiko Suite" };
    ...
    <div className="mx-auto max-w-7xl space-y-8 p-6">
      ...
      <div className="space-y-6">
        <SectionCard
          ...
          subtitle="employee-master-svc — workforce master records and employment status"
          ports="8108"
        >
        ...
        <SectionCard
          icon={Calendar}
          title="Leave & Organization Management"
          subtitle="leave-absence-svc, org-structure-svc, workforce-compliance-svc — absence management and structural compliance"
          ports="8115, 8116, 8118"
        >
          <Suspense fallback={<PanelSkeleton rows={4} />}>
            <LeaveAndOrgPanel />
          </Suspense>

...
export async function createEmployee(
  ...
  const base = employeeMasterUrl();
  const url = `${base}/v1/employees`;
  return fetchDomainServicePost<{ employee: Employee }, Employee>(
    url,
    base,
    "employee-master-svc",
    body,
...
export async function submitLeaveRequest(
  ...
  const base = leaveAbsenceUrl();
  const url = `${base}/v1/leave/requests`;
  return fetchDomainServicePost<{ request: LeaveRequest }, LeaveRequest>(
    url,
    base,
    "leave-absence-svc",
    body,
...
export async function initiateTermination(
  ...
  const url = `${base}/v1/terminations`;
